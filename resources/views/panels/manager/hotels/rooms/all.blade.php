...
<div class="card card-bordered">
    <div class="card-header">
        ...
        <div class="card-toolbar ">
            <a href="{{ route('manager.hotels.rooms.create', $hotel->id) }}" class="btn btn-primary btn-sm">افزودن اتاق جدید</a>
        </div>
    </div>
    <div class="card-body">
            @if((count($rooms) !== 0 ))
                    ...
                    <tbody>
                        ...
                        @foreach ($rooms as $room)
                            <tr class="text-center fw-bold fs-6 border-bottom border-gray-200">
                                ...
                                <td>
                                    <a href="{{ route('manager.hotels.rooms.edit',[$hotel->id, $room->id]) }}" class="btn btn-secondary btn-sm">ویرایش</a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
