...
@section('page_title', 'لیست درآمد ماهانه')


@section('breadcrumb')
    <x-panels.header.breadcrumb.menu>
        <x-panels.header.breadcrumb.item name="لیست درآمد ماهانه" muted />
    </x-panels.header.breadcrumb.menu>
@endsection
...
<div class="card card-bordered">
    <div class="card-header">
        <h3 class="card-title">لیست درآمد ماهانه</h3>
            ...
            <tbody>
                ...
                @foreach ($incomes as $income)
                    <tr class="text-center fw-bold fs-6 border-bottom border-gray-200">
                        ...
                        <td>{{ verta()->parse($income['date'].'/01')->format("%B %Y") }}</td>
