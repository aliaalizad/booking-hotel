...
<div class="card card-bordered my-5">
    ...
    <div class="card-body collapse show" id="info">
        ...
        <div class="row mb-8">
            ...
            <!--begin::Col-->
            <div class="col-xl-8">
                <input type="text" name="name" id="name" class="form-control" placeholder="عنوان را وارد کنید" value="{{ isset($permission) ? old('name', $permission->name) : old('name') }}"/>
            </div>
            <!--end::Col-->
        </div>
        <!--end::Row-->
        ...
        <div class="row mb-8">
            ...
            <!--begin::Col-->
            <div class="col-xl-8">
                <input type="text" name="label" id="label" class="form-control" placeholder="شرح را وارد کنید" value="{{ isset($permission) ? old('label', $permission->label) : old('label') }}"/>
            </div>
            <!--end::Col-->
        </div>
        <!--end::Row-->
        ...
        <div class="row mb-8">
            ...
            <div class="col-xl-8">
                <select class="form-select" name="guard" id="guard" data-control="select2" data-hide-search="true" data-placeholder="پنل را انتخاب کنید">
                    <option></option>
                    <option value="admin" @if(isset($permission)) @selected($permission->guard == 'admin') @endif >مدیریت وبسایت</option>
                    <option value="manager" @if(isset($permission)) @selected($permission->guard == 'manager') @endif>مدیریت مراکز</option>
                    <option value="member" @if(isset($permission)) @selected($permission->guard == 'member') @endif>مسئول پذیرش</option>
                </select>
            </div>
            <!--end::Col-->
        </div>
