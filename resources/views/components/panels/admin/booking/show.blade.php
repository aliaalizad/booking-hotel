                                        ...
                                        <tbody class="fw-bold text-gray-600">
                                            ...
                                            <tr>
                                                <td class="text-muted">
                                                    ...
                                                    <!--end::Svg Icon-->اتاق</div>
                                                </td>
                                                <td class="fw-bolder text-end">{{ $booking->room_number }}</td>
                                            </tr>
                                            <!--end::Length--> 
                                            @endif
                                        </tbody>
                                    ...
                                    <table class="table align-middle table-row-bordered mb-0 fs-6 gy-5 min-w-300px">
                                        ...
                                        <tbody class="fw-bold text-gray-600">
                                            ...
                                            <tr>
                                                ...
                                                <td class="fw-bolder text-end text-gray-600 text-hover-primary">{{ number_format($payments->sortByDesc('created_at')->first()->booking_amount) }} ریال</td>
                                            </tr>
                                            <!--end::Amount-->
                                        </tbody>
                                        <!--end::Table body-->
                                    ...
                                    <tbody>
                                        @foreach($payments->sortByDesc('created_at') as $payment)
                                            <tr class="text-center fw-bold fs-6 text-gray-800 border-bottom border-gray-200">
                                                ...
                                                <td>{{ number_format($payment->booking_amount) . ' ریال '}}</td>
