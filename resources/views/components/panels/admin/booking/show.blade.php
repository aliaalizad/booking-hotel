    ...
    <div class="d-flex flex-column gap-7 gap-lg-10">
        <div class="d-flex flex-wrap flex-stack gap-5 gap-lg-10">
            ...
            <ul class="nav nav-custom nav-tabs nav-line-tabs nav-line-tabs-2x border-0 fs-4 fw-bold mb-lg-n2 me-auto">
                <!--begin:::Tab item-->
                <li class="nav-item">
                    <a class="nav-link text-active-primary pb-4 active" data-bs-toggle="tab" href="#booking">رزرو</a>
                </li>
                <!--end:::Tab item-->
                <!--begin:::Tab item-->
                <li class="nav-item">
                    <a class="nav-link text-active-primary pb-4" data-bs-toggle="tab" href="#payments">پرداخت ها</a>
                </li>
                <!--end:::Tab item-->
            </ul>
            <!--end:::Tabs-->
            ...
            <div class="card card-flush py-4 flex-row-fluid">
                ...
                <div class="card-header">
                    <div class="card-title">
                        <h2>جزئیات رزرو ({{ $booking->voucher }}#)</h2>
                    </div>
                </div>
                <!--end::Card header-->
                <!--begin::Card body-->
                            ...
                            <tbody class="fw-bold text-gray-600">
                                ...
                                <tr>
                                    <td class="text-muted">
                                        ...
                                        <!--end::Svg Icon-->تاریخ ورود</div>
                                    </td>
                                    <td class="fw-bolder text-end">{{ verta($booking->checkin)->format('Y/m/d') }}</td>
                                </tr>
                                <!--end::Checkin-->
                                ...
                                <tr>
                                    <td class="text-muted">
                                        ...
                                        <!--end::Svg Icon-->تاریخ خروج</div>
                                    </td>
                                    <td class="fw-bolder text-end">{{ verta($booking->checkout)->format('Y/m/d') }}</td>
                                </tr>
                                <!--end::Checkout-->
                                ...
                                <tr>
                                    <td class="text-muted">
                                        ...
                                        <!--end::Svg Icon-->اتاق های قابل اسکان</div>
                                    </td>
                                    <td class="fw-bolder text-end">{{ implode(' - ' ,$booking->rooms) }}</td>
                                </tr>
                                <!--end::Length--> 
                            ...
                            <tbody class="fw-bold text-gray-600">
                                ...
                                <tr>
                                    <td class="text-muted">
                                        ...
                                        <!--end::Svg Icon-->شماره رهگیری
                                    </td>
                                    <td class="fw-bolder text-end text-gray-600 text-hover-primary">
                                        {{ $payments->sortByDesc('created_at')->first()->track_id }}
                                    </td>
                                </tr>
                                <!--end::TrackID-->
                                ...
                                <tr>
                                    ...
                                    <td class="fw-bolder text-end text-gray-600 text-hover-primary">
                                        @if($payments->sortByDesc('created_at')->first()->status == 0 ) {{ 'پرداخت نشده' }} @else {{ 'پرداخت شده' }} @endif
                                    </td>
                                </tr>
                                <!--end::Status-->
                                ...
                                <tr>
                                    <td class="text-muted">
                                        ...
                                        <!--end::Svg Icon-->مبلغ پرداختی
                                    </td>
                                    <td class="fw-bolder text-end text-gray-600 text-hover-primary">{{ $payments->sortByDesc('created_at')->first()->booking_amount }} ریال</td>
                                </tr>
                                <!--end::Amount-->
                            </tbody>
                            <!--end::Table body-->
        ...
        <div class="tab-content">
            <!--begin::Tab pane-->
            <div class="tab-pane fade show active" id="booking" role="tab-panel">
                <!--begin::Booking-->
                <div class="d-flex flex-column gap-7 gap-lg-10">
                                        ...
                                        <tbody class="fw-bold text-gray-600">
                                            ...
                                            <tr>
                                                <td class="text-muted">
                                                    ...
                                                    <!--end::Svg Icon-->شماره تماس</div>
                                                </td>
                                                <td class="fw-bolder text-end text-gray-600 text-hover-primary">
                                                    {{ $passengers['head']['phone'] }}
                                                </td>
                                            </tr>
                                            <!--end::Phone-->
                                        </tbody>
                                    ...
                                    <table class="table align-middle table-row-bordered mb-0 fs-6 gy-5 min-w-300px">
                                        ...
                                        <tbody class="fw-bold text-gray-600">
                                            ...
                                            <tr>
                                                ...
                                                <td class="fw-bolder text-end text-gray-600 text-hover-primary">
                                                    {{ $passengers['teacher']['name'] }}
                                                </td>
                                            </tr>
                                            <!--end::Name-->

                                            <!--begin::Personnel Code-->
                                            <tr>
                                                <td class="text-muted">
                                                    <div class="d-flex align-items-center">
                                                    ...
                                                    <!--end::Svg Icon-->شماره پرسنلی</div>
                                                </td>
                                                <td class="fw-bolder text-end text-gray-600 text-hover-primary">
                                                    {{ $passengers['teacher']['personnel_code'] }}
                                                </td>
                                            </tr>
                                            <!--end::Personnel Code-->
                                            ...
                                            <tr>
                                                <td class="text-muted">
                                                    ...
                                                    <!--end::Svg Icon-->کد ملی</div>
                                                </td>
                                                <td class="fw-bolder text-end text-gray-600 text-hover-primary">
                                                    {{ $passengers['teacher']['national_code'] }}
                                                </td>
                                            </tr>
                                            <!--end::National Code-->
                                        </tbody>
                    ...
                    <div class="card card-flush py-4 flex-row-fluid overflow-hidden">
                        ...
                        <!--begin::Card body-->
                        <div class="card-body pt-0">
                            <div class="table-responsive px-md-20">
                                <!--begin::Table-->
            ...
            <!--begin::Tab pane-->
            <div class="tab-pane fade" id="payments" role="tab-panel">
                <!--begin::Payments-->
                <div class="d-flex flex-column gap-7 gap-lg-10">
                    <!--begin::Payments history-->
                    <div class="card card-flush py-4 flex-row-fluid">
                        <!--begin::Card header-->
                        <div class="card-header">
                            <div class="card-title">
                                    ...
                                    <tbody>
                                        @foreach($payments->sortByDesc('created_at') as $payment)
                                            <tr class="text-center fw-bold fs-6 text-gray-800 border-bottom border-gray-200">
                                                ...
                                                <td>{{ verta($payment->created_at)->addMinutes(270)	 }}</td>
                                            </tr>
                                        @endforeach
                                    </tbody>
                                </table>
