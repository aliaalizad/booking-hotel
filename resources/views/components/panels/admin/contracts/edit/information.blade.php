...
<div class="card card-bordered my-5">
    ...
    <div class="card-body collapse show" id="informaion">
        ...
        <div class="row mb-8">
            ...
            <!--begin::Col-->
            <div class="col-xl-8">
                <input type="text" name="name" id="name" class="form-control form-control-solid" placeholder="نام را وارد کنید" value="{{ old('name', $contract->name) }}"/>
            </div>
            <!--end::Col-->
        </div>
        <!--end::Row-->
        ...
        <div class="row mb-8">
            ...
            <!--begin::Col-->
            <div class="col-xl-8">
                <input type="text" name="fee" id="fee" class="form-control form-control-solid" placeholder="کارمزد را وارد کنید" value="{{ old('fee', $contract->fee) }}"/>
            </div>
            <!--end::Col-->
        </div>
        <!--end::Row-->
