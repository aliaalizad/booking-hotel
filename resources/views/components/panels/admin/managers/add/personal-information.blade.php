...
<div class="card card-bordered my-5">
    ...
    <div class="card-body collapse show" id="personal_informaion">
        ...
        <div class="row mb-8">
            ...
            <!--begin::Col-->
            <div class="col-xl-8">
                <input type="text" name="email" id="email" class="form-control form-control-solid" placeholder="ایمیل را وارد کنید" value="{{ old('email') }}"/>
            </div>
            <!--end::Col-->
        </div>
        <!--end::Row-->
        ...
        <div class="row mb-8">
            ...
            <!--begin::Col-->
            <div class="col-xl-8">
                <input type="text" name="province" id="province" class="form-control form-control-solid" placeholder="استان را وارد کنید" value="{{ old('province') }}"/>
            </div>
            <!--end::Col-->
        </div>
        <!--end::Row-->
