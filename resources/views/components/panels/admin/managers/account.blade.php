...
<div class="card card-bordered my-5">
    ...
    <div class="card-body collapse show" id="account">
        ...
        <div class="row mb-8">
            ...
            <!--begin::Col-->
            <div class="col-xl-8">
                <input type="username" id="username" name="username" class="form-control" placeholder="نام کاریری را وارد کنید" value="{{ isset($manager) ? old('username', $manager->username) : old('username') }}"/>
            </div>
            <!--end::Col-->
        </div>
        <!--end::Row-->
