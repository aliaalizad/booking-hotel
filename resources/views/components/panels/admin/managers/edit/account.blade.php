...
<div class="card card-bordered my-5">
    ...
    <div class="card-body collapse show" id="account">
        ...
        <div class="row mb-8">
            ...
            <!--begin::Col-->
            <div class="col-xl-8">
                <input type="username" id="username" name="username" class="form-control form-control-solid" placeholder="نام کاریری را وارد کنید" value="{{ old('username', $manager->username) }}"/>
            </div>
            <!--end::Col-->
        </div>
        <!--end::Row-->
        ...
        <div class="row mb-8">
            ...
            <div id="change_password" class="fs-6 ps-10 collapse" >
                ...
                <div class="row mb-8">
                    ...
                    <!--begin::Col-->
                    <div class="col-xl-8">
                        <input type="password" id="current_password" name="current_password" class="form-control form-control-solid" placeholder="رمز عبور فعلی را وارد کنید"/>
                    </div>
                    <!--end::Col-->
                </div>
                <!--end::Row-->
                ...
                <div class="row mb-8">
                    ...
                    <!--begin::Col-->
                    <div class="col-xl-8">
                        <input type="password" id="password" name="password" class="form-control form-control-solid" placeholder="رمز عبور جدید را وارد کنید"/>
                    </div>
                    <!--end::Col-->
                </div>
                <!--end::Row-->
                ...
                <div class="row mb-8">
                    ...
                    <div class="col-xl-4 ">
                        <label for="password_confirmation" class="form-label d-flex align-items-center">
                            <span class="fs-6 fw-bold mt-2 mb-3  required">تکرار رمز عبور جدید:</span>
                        </label>
                    </div>
                    <!--end::Col-->
                    <!--begin::Col-->
                    <div class="col-xl-8">
                        <input type="password" id="password_confirmation" name="password_confirmation" class="form-control form-control-solid" placeholder="تکرار رمز عبور جدید را وارد کنید"/>
                    </div>
                    <!--end::Col-->
                </div>
                <!--end::Row-->
        ...
        <div class="row mb-8">
            ...
            <div class="col-xl-8">
                <div class="form-check form-switch form-check-custom form-check-solid">
                    <input class="form-check-input" type="checkbox" value="{{ $manager->is_blocked ? 0 : 1 }}" id="status" name="status" @checked($manager->is_blocked == 0)>
