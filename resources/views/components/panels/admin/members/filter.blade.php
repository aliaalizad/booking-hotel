...
<form>
    ...
    <div class="card mb-7">
        ...
        <div class="card-body">
            ...
            <!--end::Compact form-->
            <!--begin::Advance form-->
            <div class=@if( ! is_null(request('name')) or ! is_null(request('status')) or (request('manager')!=0) or (request('hotel')!=0)  ) {{ "" }} @else {{ 'collapse' }} @endif  id="search_advanced">
                <!--begin::Separator-->
                ...
                <div class="row g-8 mb-8">
                    <!--begin::Col-->
                    <div class="col-xxl-4">
                        <label class="fs-6 form-label text-dark ">مدیر</label>
                        <select name="manager" class="form-select form-select-solid"  data-allow-clear="true" data-control="select2" data-placeholder="مدیر را انتخاب کنید">
                            <option></option>
