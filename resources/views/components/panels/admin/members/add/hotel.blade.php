    ...
    <div class="row mb-8">
        ...
        <div class="col-xl-4">
            <label for="hotel" class="form-label d-flex align-items-center">
                <span class="fs-6 fw-bold mt-2 mb-3 required">هتل:</span>
            </label>
        </div>
        <!--end::Col-->
        ...
        <!--begin::Col-->
        <div class="col-xl-8">
            <select name="hotel" class="form-select form-select-solid" data-control="select2" data-allow-clear="true" data-placeholder="هتل را انتخاب کنید" >
                <option></option>
                @foreach ( App\Models\Hotel::all() as $hotel )
                    <option value="{{ $hotel->id }}" >{{ $hotel->name . " (" . $hotel->manager->name . ")" }}</option>
                @endforeach
            </select>
        </div>
        <!--end::Col-->
