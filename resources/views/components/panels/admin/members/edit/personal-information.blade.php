...
<div class="card card-bordered my-5">
    ...
    <div class="card-body collapse show" id="personal_informaion">
        ...
        <div class="row mb-8">
            ...
            <!--begin::Col-->
            <div class="col-xl-8">
                <input type="text" name="name" id="name" class="form-control form-control-solid" placeholder="نام و نام خانوادگی را وارد کنید" value="{{ old('name', $member->name) }}"/>
            </div>
            <!--end::Col-->
        </div>
        <!--end::Row-->
        ...
        <div class="row mb-8">
            ...
            <!--begin::Col-->
            <div class="col-xl-8">
                <input type="text" name="personnel_code" id="personnel_code" class="form-control form-control-solid" placeholder="کد پرسنلی را وارد کنید" value="{{ old('personnel_code', $member->personnel_code) }}"/>
            </div>
            <!--end::Col-->
        </div>
        <!--end::Row-->
        ...
        <div class="row mb-8">
            ...
            <!--begin::Col-->
            <div class="col-xl-8">
                <input type="text" name="phone" id="phone" class="form-control form-control-solid" placeholder="شماره موبایل را وارد کنید" value="{{ old('phone', $member->phone) }}"/>
            </div>
            <!--end::Col-->
        </div>
        <!--end::Row-->
