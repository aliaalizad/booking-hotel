...
@section('breadcrumb')
	...
	<ol class="breadcrumb text-muted fs-6 fw-bold">
		<li class="breadcrumb-item pe-3"><a href="#" class="pe-3">هتل ها</a></li>
		<li class="breadcrumb-item pe-3"><a href="#" class="pe-3">اتاق ها</a></li>
		<li class="breadcrumb-item px-3 text-muted">ویرایش</li>
	</ol>
...
@section('js')
    ...
    <script src="/assets/panels/plugins/custom/fullcalendar/fullcalendar.bundle.js"></script>
    <!--end::Page Vendors Javascript-->

    <!--begin::Page Custom Javascript-->
    <script src="/assets/panels/js/custom/widgets.js"></script>
    <script src="/assets/panels/js/custom/apps/chat/chat.js"></script>
    <script src="/assets/panels/js/custom/modals/create-app.js"></script>
    <script src="/assets/panels/js/custom/modals/upgrade-plan.js"></script>
